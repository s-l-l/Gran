...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/gran-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("shill");
        ...
        packageConfig.setParent("com.shill.gran.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://111.229.216.171:3306/gran?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}